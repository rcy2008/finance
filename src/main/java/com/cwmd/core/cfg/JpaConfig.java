...
@EnableJpaRepositories(basePackages = "com.cwmd.finance.repository")
public class JpaConfig implements TransactionManagementConfigurer{
    ...
    public DataSource configureDataSource(){
        ...
        dataSource.setDefaultTransactionIsolation(4);
        return dataSource;
    }
    ...
    public LocalContainerEntityManagerFactoryBean configureEntityManagerFactory(){
        ...
        entityManagerFactoryBean.setPackagesToScan("com.cwmd.finance.domain","org.stefan.snrpc.domain");
        ...
        jpaProperties.put(Environment.ISOLATION, 4);
